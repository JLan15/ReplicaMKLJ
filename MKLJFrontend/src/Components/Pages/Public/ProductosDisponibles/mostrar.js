...
class List extends Component{
  ...
  render(){
    ...
    return (
      ...
      <p>En nuestra App hay una gran variedad de negocios que probablemente tú no conozcas.</p>
      <p>A continuacion te presentamos los negocios vinculados a nuestra App</p>
      </div>
      <div>
        {cosas}
      </div>
